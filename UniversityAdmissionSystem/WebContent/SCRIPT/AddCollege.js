...
function validate(AddCollegeForm)
{
	if(!validateCollegeName(AddCollegeForm.collegeName, document.getElementById("errCollegeName")))
		return false;
	if(!validateStreet(AddCollegeForm.street, document.getElementById("errStreet")))
		return false;
	if(!validateLandmark(AddCollegeForm.landmark, document.getElementById("errLandmark")))
		return false;
	if(!validateCity(AddCollegeForm.city,document.getElementById("errCity")))
		return false;
	if(!validateState(AddCollegeForm.state, document.getElementById("errState")))
		return false;
	if(!validatePincode(AddCollegeForm.pincode, document.getElementById("errPincode")))
		return false;
	else
		return true;
}
